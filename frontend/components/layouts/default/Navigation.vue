                        ...
                        <DialogPanel
                            ...
                            <div class="space-y-6 border-t border-gray-200 px-4 py-6">
                                <div v-for="(nav, i) in navigation" :key="`nav-${i}`" class="flow-root">
                                    <NuxtLinkLocale :to="nav.to" class="-m-2 block p-2 font-medium text-gray-900">{{
                                        t(nav.name) }}
                                    </NuxtLinkLocale>
                                </div>
                            </div>
                            ...
                            <div class="space-y-6 border-t border-gray-200 px-4 py-6">
                                <div class="flow-root">
                                    <a href="#" class="-m-2 block p-2 font-medium text-gray-900">{{ t("account.create")
                                    }}</a>
                                </div>
                                <div class="flow-root">
                                    <a href="#" class="-m-2 block p-2 font-medium text-gray-900">{{ t("account.login")
                                    }}</a>
                                </div>
                            </div>
                                    ...
                                    <div class="hidden h-full lg:flex">
                                        ...
                                        <PopoverGroup class="inset-x-0 bottom-0 px-4">
                                            <div class="flex h-full justify-center space-x-8">
                                                <NuxtLinkLocale v-for="(nav, i) in navigation" :key="`nav-mobile-${i}`"
                                                    :to="nav.to"
