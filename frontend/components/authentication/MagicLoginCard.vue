      ...
      <div
        ...
        <Form @submit="submit" :validation-schema="schema" class="w-full max-w-md">
          <div class="flex gap-x-4">
            ...
            <button type="submit"
              class="flex-none rounded-md bg-white py-2.5 px-3.5 text-sm font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
              Sign-up
            </button>
          </div>
