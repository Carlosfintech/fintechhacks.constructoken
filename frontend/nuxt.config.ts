...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      appName: process.env.VUE_APP_NAME || 'Constructoken',
      appDomain: process.env.VUE_APP_DOMAIN || 'localhost:3000',
      appEnv: process.env.VUE_APP_ENV || 'development',
      apiWS: process.env.VUE_APP_DOMAIN_WS || 'ws://localhost/ws',
      apiUrl: process.env.VUE_APP_DOMAIN_API || 'http://localhost',
      apiRootUrl: process.env.VUE_APP_DOMAIN_ROOT || 'http://localhost',
      minNameLength: process.env.MINIMUM_NAME_LENGTH || '3',
      maxNameLength: process.env.MAXIMUM_NAME_LENGTH || '32',
