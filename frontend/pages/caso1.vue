        ...
        <div class="mx-auto max-w-md">
            <div class="rounded-2xl bg-white p-8 shadow-xl">
                ...
                <div class="mb-6 text-center">
                    <h1 class="text-3xl font-bold text-gray-900">💸 Remesa Internacional</h1>
                    <p class="mt-2 text-gray-600">MIGRANTE (USD) → FINSUS (MXN)</p>
                </div>
                ...
                <div v-if="!loading" class="space-y-6">
                    ...
                    <div class="rounded-lg bg-blue-50 p-4">
                        <p class="text-sm text-blue-900">
                            ...
                            • Enviarás USD desde tu cuenta PANCHO<br />
                            • FINSUS recibirá {{ displayAmount }} MXN<br />
                    ...
                    <button
                        @click="startPayment"
                        class="w-full rounded-lg bg-indigo-600 py-3 font-semibold text-white transition hover:bg-indigo-700 focus:outline-none focus:ring-4 focus:ring-indigo-300"
                    >
                        🚀 Enviar Remesa
                    </button>
                </div>
...
async function startPayment() {
    try {
        ...
        console.log('🚀 Iniciando pago con monto:', amountInCents.value)
        
        const { data, error: fetchError } = await apiOpenPayments.startMigrantePayment(amountInCents.value)
