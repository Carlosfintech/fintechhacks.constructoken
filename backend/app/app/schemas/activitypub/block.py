...
class BlockBase(BaseSchema):
    URI: Optional[str] = Field(None, description="ActivityPub URI for this Block.")
    actor_id: ULID = Field(..., description="Initiating Actor of the Block.")
    target_id: ULID = Field(..., description="Target Actor of the Block.")
